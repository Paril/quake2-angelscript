...
#undef Q2AS_OBJECT
	...
	EnsureRegisteredPropertyRaw("pmove_t", "pmove_state_t s", asOFFSET(as_pmove_t, pm.s));
	EnsureRegisteredPropertyRaw("pmove_t", "usercmd_t cmd", asOFFSET(as_pmove_t, pm.cmd));
	EnsureRegisteredPropertyRaw("pmove_t", "bool snapinitial", asOFFSET(as_pmove_t, pm.snapinitial));
	...
	EnsureRegisteredPropertyRaw("pmove_t", "vec3_t viewangles", asOFFSET(as_pmove_t, pm.viewangles));
	EnsureRegisteredPropertyRaw("pmove_t", "vec3_t mins", asOFFSET(as_pmove_t, pm.mins));
	EnsureRegisteredPropertyRaw("pmove_t", "vec3_t maxs", asOFFSET(as_pmove_t, pm.maxs));
	EnsureRegisteredPropertyRaw("pmove_t", "edict_t @groundentity", asOFFSET(as_pmove_t, pm.groundentity));
	EnsureRegisteredPropertyRaw("pmove_t", "cplane_t groundplane", asOFFSET(as_pmove_t, pm.groundplane));
	EnsureRegisteredPropertyRaw("pmove_t", "contents_t watertype", asOFFSET(as_pmove_t, pm.watertype));
	EnsureRegisteredPropertyRaw("pmove_t", "water_level_t waterlevel", asOFFSET(as_pmove_t, pm.waterlevel));
	EnsureRegisteredPropertyRaw("pmove_t", "edict_t @player", asOFFSET(as_pmove_t, pm.player));
	...
	EnsureRegisteredPropertyRaw("pmove_t", "vec3_t viewoffset", asOFFSET(as_pmove_t, pm.viewoffset));
	EnsureRegisteredPropertyRaw("pmove_t", "vec4_t screen_blend", asOFFSET(as_pmove_t, pm.screen_blend));
	EnsureRegisteredPropertyRaw("pmove_t", "refdef_flags_t rdflags", asOFFSET(as_pmove_t, pm.rdflags));
	EnsureRegisteredPropertyRaw("pmove_t", "bool jump_sound", asOFFSET(as_pmove_t, pm.jump_sound));
	EnsureRegisteredPropertyRaw("pmove_t", "bool step_clip", asOFFSET(as_pmove_t, pm.step_clip));
	EnsureRegisteredPropertyRaw("pmove_t", "float impact_delta", asOFFSET(as_pmove_t, pm.impact_delta));
