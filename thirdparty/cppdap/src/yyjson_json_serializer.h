...
namespace dap {
    namespace json {
        ...
        struct yyjsonDeserializer : public dap::Deserializer
        {
        public:
            explicit yyjsonDeserializer(const std::string &);
            ~yyjsonDeserializer();
        ...
        private:
            yyjsonDeserializer(yyjson_doc *doc, yyjson_val *val);
            yyjson_doc *const doc;
            yyjson_val *const val;
            const bool ownsJson;
        };

        class yyjsonSerializer : public ::dap::Serializer
        {
        public:
            yyjsonSerializer();
            ~yyjsonSerializer();
        ...
        private:
            yyjsonSerializer(yyjson_mut_doc *doc, yyjson_mut_val *val);
