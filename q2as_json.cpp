...
static void Q2AS_RegisterMutableJson(q2as_registry &registry)
{
    ...
    registry
        ...
        .methods({
            ...
            { "json_mutval null_()",       asMETHOD(q2as_yyjson_mut_doc, mut_null),  asCALL_THISCALL },
            { "json_mutval true_()",       asMETHOD(q2as_yyjson_mut_doc, mut_true),  asCALL_THISCALL },
            { "json_mutval false_()",      asMETHOD(q2as_yyjson_mut_doc, mut_false), asCALL_THISCALL },
            { "json_mutval bool_(bool)",   asMETHOD(q2as_yyjson_mut_doc, mut_bool),  asCALL_THISCALL },
            { "json_mutval uint_(uint64)", asMETHOD(q2as_yyjson_mut_doc, mut_uint),  asCALL_THISCALL },
            { "json_mutval sint(int64)",   asMETHOD(q2as_yyjson_mut_doc, mut_sint),  asCALL_THISCALL },
            { "json_mutval int_(int64)",   asMETHOD(q2as_yyjson_mut_doc, mut_int),   asCALL_THISCALL },

            { "json_mutval val_(bool)",   asMETHODPR(q2as_yyjson_mut_doc, val, (bool), q2as_yyjson_mut_val),     asCALL_THISCALL },
            { "json_mutval val_(uint8)",  asMETHODPR(q2as_yyjson_mut_doc, val, (uint8_t), q2as_yyjson_mut_val),  asCALL_THISCALL },
            { "json_mutval val_(uint16)", asMETHODPR(q2as_yyjson_mut_doc, val, (uint16_t), q2as_yyjson_mut_val), asCALL_THISCALL },
            { "json_mutval val_(uint32)", asMETHODPR(q2as_yyjson_mut_doc, val, (uint32_t), q2as_yyjson_mut_val), asCALL_THISCALL },
            { "json_mutval val_(uint64)", asMETHODPR(q2as_yyjson_mut_doc, val, (uint64_t), q2as_yyjson_mut_val), asCALL_THISCALL },
            { "json_mutval val_(int8)",   asMETHODPR(q2as_yyjson_mut_doc, val, (int8_t), q2as_yyjson_mut_val),   asCALL_THISCALL },
            { "json_mutval val_(int16)",  asMETHODPR(q2as_yyjson_mut_doc, val, (int16_t), q2as_yyjson_mut_val),  asCALL_THISCALL },
            { "json_mutval val_(int32)",  asMETHODPR(q2as_yyjson_mut_doc, val, (int32_t), q2as_yyjson_mut_val),  asCALL_THISCALL },
            { "json_mutval val_(int64)",  asMETHODPR(q2as_yyjson_mut_doc, val, (int64_t), q2as_yyjson_mut_val),  asCALL_THISCALL },
            { "json_mutval val_(float)",  asMETHODPR(q2as_yyjson_mut_doc, val, (float), q2as_yyjson_mut_val),    asCALL_THISCALL },
            { "json_mutval val_(double)", asMETHODPR(q2as_yyjson_mut_doc, val, (double), q2as_yyjson_mut_val),   asCALL_THISCALL },

            { "json_mutval real(double)",                    asMETHOD(q2as_yyjson_mut_doc, mut_real), asCALL_THISCALL },
            { "json_mutval str(const string &in, uint len)", asMETHOD(q2as_yyjson_mut_doc, mut_strl), asCALL_THISCALL },
            { "json_mutval str(const string &in)",           asMETHOD(q2as_yyjson_mut_doc, mut_str),  asCALL_THISCALL },
            { "json_mutval obj()",                           asMETHOD(q2as_yyjson_mut_doc, mut_obj),  asCALL_THISCALL },
            { "json_mutval arr()",                           asMETHOD(q2as_yyjson_mut_doc, mut_arr),  asCALL_THISCALL },
...
static void Q2AS_RegisterImmutableJson(q2as_registry &registry)
{
    ...
    registry
        ...
        .methods({
            ...
            { "void get(? &out) const",      asMETHODPR(q2as_yyjson_val, get, (void *, int) const, void), asCALL_THISCALL },
